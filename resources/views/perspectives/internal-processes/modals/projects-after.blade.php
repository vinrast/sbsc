<div class="modal fade in" id="modal-projects-after" style="display: none; padding-right: 15px;">
          ...
          <div class="modal-body">
            ...
            <div class="form-group container-input_1-help">
              <div class="col-sm-10 col-sm-offset-1">
                <label for="projectsAfter">Proyectos entregados fuera de tiempo*</label>
                <input type="number" class="form-control" id="projectsAfter" name="input_1" min="0" value="" placeholder="Número de proyectos">
