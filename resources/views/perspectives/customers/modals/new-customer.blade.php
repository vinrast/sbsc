          ...
          <div class="modal-body">
            ...
            <div class="form-group" id="container-target-help">
              <div class="col-sm-10 col-sm-offset-1">
                <label for="inputTarget">Clientes Incorporados*</label>
                <input type="number" class="form-control" id="inputTarget" name="performance_threshold" value="" placeholder=" Número de clientes">
            ...
            <div class="form-group" id="container-threshold-help">
              <div class="col-sm-10 col-sm-offset-1">
                <label for="inputThreshold">Clientes Totales*</label>
                <input type="number" class="form-control" id="inputThreshold" name="performance_threshold" value="" placeholder=" Número de clientes">
