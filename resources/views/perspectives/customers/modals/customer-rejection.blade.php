<div class="modal fade in" id="modal-customer-rejection" style="display: none; padding-right: 15px;">
          ...
          <div class="modal-body">
            ...
            <div class="form-group container-input_1-help">
              <div class="col-sm-10 col-sm-offset-1">
                ...
                <input type="number" class="form-control" id="rejectionCoste" name="input_1" min="0" value="" step=".01" placeholder="Costo Monetario">
            ...
            <div class="form-group container-input_2-help">
              <div class="col-sm-10 col-sm-offset-1">
                ...
                <input type="number" class="form-control" id="billing" name="input_2" value="" min="0" step=".01" placeholder=" Facturación Total">
