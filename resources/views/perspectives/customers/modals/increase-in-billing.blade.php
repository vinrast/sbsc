          ...
          <div class="modal-body">
            ...
            <div class="form-group container-input_1-help">
              <div class="col-sm-10 col-sm-offset-1">
                ...
                <input type="number" class="form-control" id="previousBilling" name="input_1" value="" step=".01" placeholder=" Monto facturado del periodo anterior">
            ...
            <div class="form-group container-input_2-help">
              <div class="col-sm-10 col-sm-offset-1">
                ...
                <input type="number" class="form-control" id="totalBilling" name="input_2" value="" step=".01" placeholder=" Monto facturado actual">
