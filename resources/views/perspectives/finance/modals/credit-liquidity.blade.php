<div class="modal fade in" id="modal-credit-liquidity" style="display: none; padding-right: 15px;">
      ...
      <div class="modal-content">
        ...
        <form class="form-horizontal save-form">
          <div class="modal-body">
            <input type="hidden" name="formula_type" value="4">
            ...
            <div class="form-group container-input_1-help">
              <div class="col-sm-10 col-sm-offset-1">
                ...
                <input type="number" class="form-control" id="accountsReceivable" name="input_1" value="" step=".01" min="0" placeholder="Total CxC">
            ...
            <div class="form-group container-input_2-help">
              <div class="col-sm-10 col-sm-offset-1">
                <label for="netSales">Ventas netas*</label>
                <input type="number" class="form-control" id="netSales" name="input_2" min="0" step=".01" value="" placeholder="Ventas netas">
