<div class="modal fade in" id="modal-roe" style="display: none; padding-right: 15px;">
          ...
          <div class="modal-body">
            ...
            <div class="form-group container-input_1-help">
              <div class="col-sm-10 col-sm-offset-1">
                <label for="operationalUtility">Utilidad Operacional*</label>
                <input type="number" class="form-control" id="operationalUtility" name="input_1" step=".01" value="" min="0" placeholder=" Utilidad">
            ...
            <div class="form-group container-input_2-help">
              <div class="col-sm-10 col-sm-offset-1">
                ...
                <input type="number" class="form-control" id="heritage" name="input_2" min="0"  step=".01" value="" placeholder=" Patrimonio">
