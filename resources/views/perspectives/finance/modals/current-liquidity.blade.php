<div class="modal fade in" id="modal-current-liquidity" style="display: none; padding-right: 15px;">
          ...
          <div class="modal-body">
            ...
            <div class="form-group container-input_1-help">
              <div class="col-sm-10 col-sm-offset-1">
                <label for="activeCurrent">Activo Corriente*</label>
                <input type="number" class="form-control" id="activeCurrent" name="input_1" value="" step=".01" min="0" placeholder="Activo">
            ...
            <div class="form-group container-input_2-help">
              <div class="col-sm-10 col-sm-offset-1">
                <label for="pasiveCurrent">Pasivo Corriente*</label>
                <input type="number" class="form-control" id="pasiveCurrent" name="input_2" min="0" value="" step=".01" placeholder="Pasivo">
