<div class="modal fade in" id="modal-asset-indebtedness" style="display: none; padding-right: 15px;">
          ...
          <div class="modal-body">
            ...
            <div class="form-group container-input_1-help">
              <div class="col-sm-10 col-sm-offset-1">
                <label for="total-liabilities">Total Pasivos*</label>
                <input type="number" class="form-control" id="total-liabilities" name="input_1" value="" step=".01" min="0" placeholder="Pasivos">
            ...
            <div class="form-group container-input_2-help">
              <div class="col-sm-10 col-sm-offset-1">
                <label for="total-asset">Total Activos*</label>
                <input type="number" class="form-control" id="total-asset" name="input_2" min="0" value="" step=".01" placeholder="Activos">
