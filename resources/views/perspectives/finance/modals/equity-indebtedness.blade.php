<div class="modal fade in" id="modal-equity-indebtedness" style="display: none; padding-right: 15px;">
          ...
          <div class="modal-body">
            ...
            <div class="form-group container-input_1-help">
              <div class="col-sm-10 col-sm-offset-1">
                <label for="total-liabilities-1">Total Pasivos*</label>
                <input type="number" class="form-control" id="total-liabilities-1" name="input_1" step=".01" value="" min="0" placeholder="Pasivos">
            ...
            <div class="form-group container-input_2-help">
              <div class="col-sm-10 col-sm-offset-1">
                <label for="heritage-1">Patrimonio*</label>
                <input type="number" class="form-control" id="heritage-1" name="input_2" min="0" step=".01" value="" placeholder="Patrimonio">
