<div class="modal fade in" id="modal-net-profitability" style="display: none; padding-right: 15px;">
          ...
          <div class="modal-body">
            ...
            <div class="form-group container-input_1-help">
              <div class="col-sm-10 col-sm-offset-1">
                ...
                <input type="number" class="form-control" id="utility" name="input_1" value="" step=".01" min="0" placeholder="Utilidad">
            ...
            <div class="form-group container-input_2-help">
              <div class="col-sm-10 col-sm-offset-1">
                ...
                <input type="number" class="form-control" id="assets" name="input_2" min="0" step=".01" value="" placeholder="Activos">
