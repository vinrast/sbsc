<div class="modal fade in" id="modal-creativity" style="display: none; padding-right: 15px;">
          ...
          <div class="modal-body">
            ...
            <div class="form-group container-input_1-help">
              <div class="col-sm-10 col-sm-offset-1">
                <label for="suggestionAdd">Sugerencias Implementadas*</label>
                <input type="number" class="form-control" id="suggestionAdd" name="input_1" value="" min="0" placeholder="Nro de sugerencias">
            ...
            <div class="form-group container-input_2-help">
              <div class="col-sm-10 col-sm-offset-1">
                <label for="suggestionTotal">Sugerencias Recibidas*</label>
                <input type="number" class="form-control" id="suggestionTotal" name="input_2" min="0" value="" placeholder="Total sugerencias">
