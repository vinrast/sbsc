<div class="modal fade in" id="modal-claims" style="display: none; padding-right: 15px;">
          ...
          <div class="modal-body">
            ...
            <div class="form-group container-input_1-help">
              <div class="col-sm-10 col-sm-offset-1">
                <label for="claimsAnswered">Reclamos Atendidos*</label>
                <input type="number" class="form-control" id="claimsAnswered" name="input_1" value="" min="0" placeholder="Nro de reclamos">
            ...
            <div class="form-group container-input_2-help">
              <div class="col-sm-10 col-sm-offset-1">
                <label for="totalClaims">Total Reclamos*</label>
                <input type="number" class="form-control" id="totalClaims" name="input_2" min="0" value="" placeholder="Total reclamos">
