<div class="modal fade in" id="modal-add-services" style="display: none; padding-right: 15px;">
          ...
          <div class="modal-body">
            ...
            <div class="form-group container-input_1-help">
              <div class="col-sm-10 col-sm-offset-1">
                <label for="newServices">Servicios Nuevos*</label>
                <input type="number" class="form-control" id="newServices" name="input_1" value="" min="0" placeholder="Cantidad de servicios">
            ...
            <div class="form-group container-input_2-help">
              <div class="col-sm-10 col-sm-offset-1">
                <label for="currentServices">Servicios Actuales*</label>
                <input type="number" class="form-control" id="currentServices" name="input_2" min="0" value="" placeholder="Cantidad de servicios">
