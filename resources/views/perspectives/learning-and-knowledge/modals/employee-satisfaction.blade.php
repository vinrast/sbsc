<div class="modal fade in" id="modal-employee-satisfaction" style="display: none; padding-right: 15px;">
          ...
          <div class="modal-body">
            ...
            <div class="form-group container-input_1-help">
              <div class="col-sm-10 col-sm-offset-1">
                <label for="SurveyResult-1">Resultado de Encuesta*</label>
                <input type="number" class="form-control" id="SurveyResult-1" name="input_1" value="" min="0" placeholder="Resultado de encuestas">
            ...
            <div class="form-group container-input_2-help">
              <div class="col-sm-10 col-sm-offset-1">
                <label for="totalSurvey-1">Total Encuestas*</label>
                <input type="number" class="form-control" id="totalSurvey-1" name="input_2" min="0" value="" placeholder="Total Encuestas">
