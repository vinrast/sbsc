...
<div class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3">
  @if(session()->has('message'))
    <div class="alert alert-success alert-dismissible">
      ...
      <h4><i class="icon fa fa-check"></i>Usuario Guardado Correctamente!</h4>
      <p>{!! session()->get('message') !!}.</p>
    </div>
  @endif
  @component('users.partials._form')
    @slot('title','Nuevo Usuario')
    <form class="form-horizontal" action="{{ route('usuarios.almacenar') }}" method="post" enctype="multipart/form-data">
      @csrf
